    ...
    .then(function (response) {
      if (response.ok) {
        response.json().then(function (data) {
          ...
          //planet info for Leo and Cancer
          ...
          if (data.ruling_planet === "Sun") {
            ...
            var planetDescription = document.querySelector(
              '[data-js="planet-description"]'
            );
            ...
            descriptionMoon.innerHTML =
              "<b>Decription:</b>The moon is the fifth largest satellite in the Solar System and the largest and most massive relative to its parent planet, with a diameter about one-quarter that of Earth (comparable to the width of Australia). ";
            var planetDescription = document.querySelector(
              '[data-js="planet-description"]'
            );
          ...
          var cardContainerEl = document.querySelector(
            '[data-js="card-container"]'
          );
          cardContainerEl.classList.remove("display-none");
          var cardInfoChildrenEls = document.querySelectorAll(".card-info");
          cardInfoChildrenEls.forEach((infoChildEl) =>
            infoChildEl.classList.remove("display-none")
          );

          var welcomeMessageEl = document.querySelector(
            '[data-js="welcome-message"]'
          );
          var userSignUpper =
            userSign.charAt(0).toUpperCase() + userSign.slice(1);
          welcomeMessageEl.innerHTML = `<h1>Hi ${userName}, your sign is ${userSignUpper}.</h1>`;
